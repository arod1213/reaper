...
def Button(ctx, label, size_wInOptional=None, size_hInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_double(size_wInOptional) if size_wInOptional != None else None,
        c_double(size_hInOptional) if size_hInOptional != None else None,
    )
    rval = Button.func(
        args[0],
        args[1],
        byref(args[2]) if args[2] != None else None,
        byref(args[3]) if args[3] != None else None,
    )
    return rval
...
def CheckboxFlags(ctx, label, flagsInOut, flags_value):
    if not hasattr(CheckboxFlags, "func"):
        ...
        CheckboxFlags.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_int)(
            proc
        )
...
def InvisibleButton(ctx, str_id, size_w, size_h, flagsInOptional=None):
    if not hasattr(InvisibleButton, "func"):
        ...
        InvisibleButton.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(str_id),
        c_double(size_w),
        c_double(size_h),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = InvisibleButton.func(
        args[0], args[1], args[2], args[3], byref(args[4]) if args[4] != None else None
    )
    return rval
...
def RadioButtonEx(ctx, label, vInOut, v_button):
    if not hasattr(RadioButtonEx, "func"):
        ...
        RadioButtonEx.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_int)(
            proc
        )
...
def ColorButton(
    ...
    desc_id,
    col_rgba,
    flagsInOptional=None,
    size_wInOptional=None,
    size_hInOptional=None,
):
    if not hasattr(ColorButton, "func"):
        proc = rpr_getfp("ImGui_ColorButton")
        ColorButton.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_int, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(desc_id),
    ...
    rval = ColorButton.func(
        args[0],
        args[1],
        args[2],
        byref(args[3]) if args[3] != None else None,
        byref(args[4]) if args[4] != None else None,
        byref(args[5]) if args[5] != None else None,
    )
    return rval
...
def ColorEdit3(ctx, label, col_rgbInOut, flagsInOptional=None):
    if not hasattr(ColorEdit3, "func"):
        ...
        ColorEdit3.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
    ...
    rval = ColorEdit3.func(
        args[0], args[1], byref(args[2]), byref(args[3]) if args[3] != None else None
    )
    return rval, int(args[2].value)
...
def ColorEdit4(ctx, label, col_rgbaInOut, flagsInOptional=None):
    if not hasattr(ColorEdit4, "func"):
        ...
        ColorEdit4.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
...
def ColorPicker3(ctx, label, col_rgbInOut, flagsInOptional=None):
    if not hasattr(ColorPicker3, "func"):
        ...
        ColorPicker3.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
...
def ColorPicker4(
    ctx, label, col_rgbaInOut, flagsInOptional=None, ref_colInOptional=None
):
    if not hasattr(ColorPicker4, "func"):
        proc = rpr_getfp("ImGui_ColorPicker4")
        ColorPicker4.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_int(col_rgbaInOut),
        c_int(flagsInOptional) if flagsInOptional != None else None,
        c_int(ref_colInOptional) if ref_colInOptional != None else None,
    )
    rval = ColorPicker4.func(
        args[0],
        args[1],
        byref(args[2]),
        byref(args[3]) if args[3] != None else None,
...
def BeginCombo(ctx, label, preview_value, flagsInOptional=None):
    if not hasattr(BeginCombo, "func"):
        ...
        BeginCombo.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_char_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        rpr_packsc(preview_value),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = BeginCombo.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )
    return rval


def Combo(
    ctx, label, current_itemInOut, items, popup_max_height_in_itemsInOptional=None
):
    if not hasattr(Combo, "func"):
        proc = rpr_getfp("ImGui_Combo")
        Combo.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_char_p, c_int, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_int(current_itemInOut),
        rpr_packsc(items),
        c_int(len(items) + 1),
        c_int(popup_max_height_in_itemsInOptional)
        if popup_max_height_in_itemsInOptional != None
        else None,
    )
    rval = Combo.func(
        args[0],
...
def BeginListBox(ctx, label, size_wInOptional=None, size_hInOptional=None):
    if not hasattr(BeginListBox, "func"):
        ...
        BeginListBox.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
...
def ListBox(ctx, label, current_itemInOut, items, height_in_itemsInOptional=None):
    ...
    args = (
        ...
        rpr_packsc(items),
        c_int(len(items) + 1),
        c_int(height_in_itemsInOptional) if height_in_itemsInOptional != None else None,
    )
    rval = ListBox.func(
        args[0],
        args[1],
...
def Selectable(
    ...
    if not hasattr(Selectable, "func"):
        ...
        Selectable.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_bool(p_selectedInOutOptional) if p_selectedInOutOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
        c_double(size_wInOptional) if size_wInOptional != None else None,
        c_double(size_hInOptional) if size_hInOptional != None else None,
    )
    rval = Selectable.func(
        args[0],
        args[1],
        byref(args[2]) if args[2] != None else None,
        byref(args[3]) if args[3] != None else None,
...
def CreateContext(label, config_flagsInOptional=None):
    ...
    args = (
        rpr_packsc(label),
        c_int(config_flagsInOptional) if config_flagsInOptional != None else None,
    )
...
def ConfigVar_DebugBeginReturnValueLoop():
    ...
    if not hasattr(ConfigVar_DebugBeginReturnValueLoop, "cache"):
        ConfigVar_DebugBeginReturnValueLoop.cache = (
            ConfigVar_DebugBeginReturnValueLoop.func()
        )
...
def ConfigVar_DebugBeginReturnValueOnce():
    ...
    if not hasattr(ConfigVar_DebugBeginReturnValueOnce, "cache"):
        ConfigVar_DebugBeginReturnValueOnce.cache = (
            ConfigVar_DebugBeginReturnValueOnce.func()
        )
...
def ConfigVar_DockingTransparentPayload():
    ...
    if not hasattr(ConfigVar_DockingTransparentPayload, "cache"):
        ConfigVar_DockingTransparentPayload.cache = (
            ConfigVar_DockingTransparentPayload.func()
        )
...
def ConfigVar_HoverFlagsForTooltipMouse():
    ...
    if not hasattr(ConfigVar_HoverFlagsForTooltipMouse, "cache"):
        ConfigVar_HoverFlagsForTooltipMouse.cache = (
            ConfigVar_HoverFlagsForTooltipMouse.func()
        )
...
def ConfigVar_HoverFlagsForTooltipNav():
    ...
    if not hasattr(ConfigVar_HoverFlagsForTooltipNav, "cache"):
        ConfigVar_HoverFlagsForTooltipNav.cache = (
            ConfigVar_HoverFlagsForTooltipNav.func()
        )
...
def ConfigVar_InputTextEnterKeepActive():
    ...
    if not hasattr(ConfigVar_InputTextEnterKeepActive, "cache"):
        ConfigVar_InputTextEnterKeepActive.cache = (
            ConfigVar_InputTextEnterKeepActive.func()
        )
...
def ConfigVar_MouseDoubleClickMaxDist():
    ...
    if not hasattr(ConfigVar_MouseDoubleClickMaxDist, "cache"):
        ConfigVar_MouseDoubleClickMaxDist.cache = (
            ConfigVar_MouseDoubleClickMaxDist.func()
        )
...
def ConfigVar_WindowsMoveFromTitleBarOnly():
    ...
    if not hasattr(ConfigVar_WindowsMoveFromTitleBarOnly, "cache"):
        ConfigVar_WindowsMoveFromTitleBarOnly.cache = (
            ConfigVar_WindowsMoveFromTitleBarOnly.func()
        )
...
def AcceptDragDropPayload(ctx, type, flagsInOptional=None):
    if not hasattr(AcceptDragDropPayload, "func"):
        ...
        AcceptDragDropPayload.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_int, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(type),
    ...
    rval = AcceptDragDropPayload.func(
        args[0], args[1], args[2], args[3], byref(args[4]) if args[4] != None else None
    )
...
def AcceptDragDropPayloadFiles(ctx, flagsInOptional=None):
    if not hasattr(AcceptDragDropPayloadFiles, "func"):
        ...
        AcceptDragDropPayloadFiles.func = CFUNCTYPE(
    ...
    rval = AcceptDragDropPayloadFiles.func(
        args[0], byref(args[1]), byref(args[2]) if args[2] != None else None
    )
...
def AcceptDragDropPayloadRGB(ctx, flagsInOptional=None):
    if not hasattr(AcceptDragDropPayloadRGB, "func"):
        ...
        AcceptDragDropPayloadRGB.func = CFUNCTYPE(c_bool, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
    ...
    rval = AcceptDragDropPayloadRGB.func(
        args[0], byref(args[1]), byref(args[2]) if args[2] != None else None
    )
    return rval, int(args[1].value)
...
def AcceptDragDropPayloadRGBA(ctx, flagsInOptional=None):
    if not hasattr(AcceptDragDropPayloadRGBA, "func"):
        ...
        AcceptDragDropPayloadRGBA.func = CFUNCTYPE(
            c_bool, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
    ...
    rval = AcceptDragDropPayloadRGBA.func(
        args[0], byref(args[1]), byref(args[2]) if args[2] != None else None
    )
    return rval, int(args[1].value)
...
def BeginDragDropSource(ctx, flagsInOptional=None):
    ...
    rval = BeginDragDropSource.func(
        args[0], byref(args[1]) if args[1] != None else None
    )
    return rval
...
def GetDragDropPayload(ctx):
    if not hasattr(GetDragDropPayload, "func"):
        ...
        GetDragDropPayload.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_int, c_char_p, c_int, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packs(0),
    ...
    rval = GetDragDropPayload.func(
        args[0], args[1], args[2], args[3], args[4], byref(args[5]), byref(args[6])
    )
    return (
        rval,
        rpr_unpacks(args[1]),
...
def GetDragDropPayloadFile(ctx, index):
    if not hasattr(GetDragDropPayloadFile, "func"):
        ...
        GetDragDropPayloadFile.func = CFUNCTYPE(
            c_bool, c_void_p, c_int, c_char_p, c_int
        )(proc)
...
def SetDragDropPayload(ctx, type, data, condInOptional=None):
    if not hasattr(SetDragDropPayload, "func"):
        ...
        SetDragDropPayload.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(type),
        rpr_packsc(data),
        c_int(condInOptional) if condInOptional != None else None,
    )
    rval = SetDragDropPayload.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )
    return rval
...
def DragDropFlags_AcceptBeforeDelivery():
    ...
    if not hasattr(DragDropFlags_AcceptBeforeDelivery, "cache"):
        DragDropFlags_AcceptBeforeDelivery.cache = (
            DragDropFlags_AcceptBeforeDelivery.func()
        )
...
def DragDropFlags_AcceptNoDrawDefaultRect():
    ...
    if not hasattr(DragDropFlags_AcceptNoDrawDefaultRect, "cache"):
        DragDropFlags_AcceptNoDrawDefaultRect.cache = (
            DragDropFlags_AcceptNoDrawDefaultRect.func()
        )
...
def DragDropFlags_AcceptNoPreviewTooltip():
    ...
    if not hasattr(DragDropFlags_AcceptNoPreviewTooltip, "cache"):
        DragDropFlags_AcceptNoPreviewTooltip.cache = (
            DragDropFlags_AcceptNoPreviewTooltip.func()
        )
...
def DragDropFlags_SourceNoDisableHover():
    ...
    if not hasattr(DragDropFlags_SourceNoDisableHover, "cache"):
        DragDropFlags_SourceNoDisableHover.cache = (
            DragDropFlags_SourceNoDisableHover.func()
        )
...
def DragDropFlags_SourceNoHoldToOpenOthers():
    ...
    if not hasattr(DragDropFlags_SourceNoHoldToOpenOthers, "cache"):
        DragDropFlags_SourceNoHoldToOpenOthers.cache = (
            DragDropFlags_SourceNoHoldToOpenOthers.func()
        )
...
def DragDropFlags_SourceNoPreviewTooltip():
    ...
    if not hasattr(DragDropFlags_SourceNoPreviewTooltip, "cache"):
        DragDropFlags_SourceNoPreviewTooltip.cache = (
            DragDropFlags_SourceNoPreviewTooltip.func()
        )
...
def DragDouble(
    ...
    label,
    vInOut,
    v_speedInOptional=None,
    v_minInOptional=None,
    v_maxInOptional=None,
    formatInOptional=None,
    flagsInOptional=None,
):
    if not hasattr(DragDouble, "func"):
        proc = rpr_getfp("ImGui_DragDouble")
        DragDouble.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
    ...
    args = (
        ...
        rpr_packsc(label),
        c_double(vInOut),
        c_double(v_speedInOptional) if v_speedInOptional != None else None,
        c_double(v_minInOptional) if v_minInOptional != None else None,
        c_double(v_maxInOptional) if v_maxInOptional != None else None,
        rpr_packsc(formatInOptional) if formatInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = DragDouble.func(
        args[0],
        args[1],
        byref(args[2]),
        byref(args[3]) if args[3] != None else None,
        ...
        byref(args[5]) if args[5] != None else None,
        args[6],
        byref(args[7]) if args[7] != None else None,
    )
...
def DragDouble2(
    ...
    rval = DragDouble2.func(
        ...
        byref(args[4]) if args[4] != None else None,
        byref(args[5]) if args[5] != None else None,
        byref(args[6]) if args[6] != None else None,
        args[7],
        byref(args[8]) if args[8] != None else None,
    )
...
def DragDouble3(
    ...
    rval = DragDouble3.func(
        ...
        byref(args[7]) if args[7] != None else None,
        args[8],
        byref(args[9]) if args[9] != None else None,
    )
...
def DragDouble4(
    ...
    rval = DragDouble4.func(
        ...
        byref(args[8]) if args[8] != None else None,
        args[9],
        byref(args[10]) if args[10] != None else None,
    )
    return (
        rval,
        float(args[2].value),
...
def DragDoubleN(
    ...
    args = (
        ...
        rpr_packsc(label),
        c_void_p(values),
        c_double(speedInOptional) if speedInOptional != None else None,
        c_double(minInOptional) if minInOptional != None else None,
        c_double(maxInOptional) if maxInOptional != None else None,
        rpr_packsc(formatInOptional) if formatInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = DragDoubleN.func(
        args[0],
        args[1],
        args[2],
        byref(args[3]) if args[3] != None else None,
...
def DragFloatRange2(
    ...
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_double(v_current_minInOut),
        c_double(v_current_maxInOut),
        c_double(v_speedInOptional) if v_speedInOptional != None else None,
        c_double(v_minInOptional) if v_minInOptional != None else None,
        c_double(v_maxInOptional) if v_maxInOptional != None else None,
        rpr_packsc(formatInOptional) if formatInOptional != None else None,
        rpr_packsc(format_maxInOptional) if format_maxInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = DragFloatRange2.func(
        args[0],
        args[1],
        byref(args[2]),
        byref(args[3]),
...
def DragInt(
    ...
    args = (
        ...
        c_int(vInOut),
        c_double(v_speedInOptional) if v_speedInOptional != None else None,
        c_int(v_minInOptional) if v_minInOptional != None else None,
        c_int(v_maxInOptional) if v_maxInOptional != None else None,
        rpr_packsc(formatInOptional) if formatInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = DragInt.func(
...
def DragIntRange2(
    ...
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_int(v_current_minInOut),
        c_int(v_current_maxInOut),
        c_double(v_speedInOptional) if v_speedInOptional != None else None,
        c_int(v_minInOptional) if v_minInOptional != None else None,
        c_int(v_maxInOptional) if v_maxInOptional != None else None,
        rpr_packsc(formatInOptional) if formatInOptional != None else None,
...
def SliderAngle(
    ...
    label,
    v_radInOut,
    v_degrees_minInOptional=None,
    v_degrees_maxInOptional=None,
    formatInOptional=None,
    flagsInOptional=None,
):
    if not hasattr(SliderAngle, "func"):
        proc = rpr_getfp("ImGui_SliderAngle")
        SliderAngle.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_double(v_radInOut),
        c_double(v_degrees_minInOptional) if v_degrees_minInOptional != None else None,
        c_double(v_degrees_maxInOptional) if v_degrees_maxInOptional != None else None,
        rpr_packsc(formatInOptional) if formatInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = SliderAngle.func(
        args[0],
        args[1],
        byref(args[2]),
        byref(args[3]) if args[3] != None else None,
...
def SliderDouble(
    ctx, label, vInOut, v_min, v_max, formatInOptional=None, flagsInOptional=None
):
    if not hasattr(SliderDouble, "func"):
        proc = rpr_getfp("ImGui_SliderDouble")
        SliderDouble.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_double, c_double, c_char_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
...
def SliderDoubleN(
    ctx, label, values, v_min, v_max, formatInOptional=None, flagsInOptional=None
):
    if not hasattr(SliderDoubleN, "func"):
        proc = rpr_getfp("ImGui_SliderDoubleN")
        SliderDoubleN.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_double, c_double, c_char_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
...
def SliderInt(
    ...
    if not hasattr(SliderInt, "func"):
        ...
        SliderInt.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_int, c_int, c_char_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
...
def DrawFlags_RoundCornersBottomRight():
    ...
    if not hasattr(DrawFlags_RoundCornersBottomRight, "cache"):
        DrawFlags_RoundCornersBottomRight.cache = (
            DrawFlags_RoundCornersBottomRight.func()
        )
...
def DrawList_PushClipRect(
    draw_list,
    clip_rect_min_x,
    clip_rect_min_y,
    clip_rect_max_x,
    clip_rect_max_y,
    intersect_with_current_clip_rectInOptional=None,
):
    if not hasattr(DrawList_PushClipRect, "func"):
        proc = rpr_getfp("ImGui_DrawList_PushClipRect")
        DrawList_PushClipRect.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(clip_rect_min_x),
        c_double(clip_rect_min_y),
        c_double(clip_rect_max_x),
        c_double(clip_rect_max_y),
        c_bool(intersect_with_current_clip_rectInOptional)
        if intersect_with_current_clip_rectInOptional != None
        else None,
    )
    DrawList_PushClipRect.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_AddBezierCubic(
    ...
    args = (
        ...
        c_int(col_rgba),
        c_double(thickness),
        c_int(num_segmentsInOptional) if num_segmentsInOptional != None else None,
    )
    DrawList_AddBezierCubic.func(
        args[0],
        args[1],
        args[2],
        args[3],
        ...
        args[9],
        args[10],
        byref(args[11]) if args[11] != None else None,
    )


def DrawList_AddBezierQuadratic(
    draw_list,
    p1_x,
    p1_y,
    p2_x,
    ...
    if not hasattr(DrawList_AddBezierQuadratic, "func"):
        ...
        DrawList_AddBezierQuadratic.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    DrawList_AddBezierQuadratic.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_AddCircle(
    ...
    col_rgba,
    num_segmentsInOptional=None,
    thicknessInOptional=None,
):
    if not hasattr(DrawList_AddCircle, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddCircle")
        DrawList_AddCircle.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_int, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(center_x),
        ...
        c_int(col_rgba),
        c_int(num_segmentsInOptional) if num_segmentsInOptional != None else None,
        c_double(thicknessInOptional) if thicknessInOptional != None else None,
    )
    DrawList_AddCircle.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_AddCircleFilled(
    draw_list, center_x, center_y, radius, col_rgba, num_segmentsInOptional=None
):
    if not hasattr(DrawList_AddCircleFilled, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddCircleFilled")
        DrawList_AddCircleFilled.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_int, c_void_p
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(center_x),
...
def DrawList_AddConcavePolyFilled(draw_list, points, col_rgba):
    if not hasattr(DrawList_AddConcavePolyFilled, "func"):
        ...
        DrawList_AddConcavePolyFilled.func = CFUNCTYPE(None, c_void_p, c_void_p, c_int)(
            proc
        )
...
def DrawList_AddConvexPolyFilled(draw_list, points, col_rgba):
    if not hasattr(DrawList_AddConvexPolyFilled, "func"):
        ...
        DrawList_AddConvexPolyFilled.func = CFUNCTYPE(None, c_void_p, c_void_p, c_int)(
            proc
        )
    args = (c_void_p(draw_list), c_void_p(points), c_int(col_rgba))
...
def DrawList_AddEllipse(
    ...
    if not hasattr(DrawList_AddEllipse, "func"):
        ...
        DrawList_AddEllipse.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    args = (
        ...
        c_double(radius_y),
        c_int(col_rgba),
        c_double(rotInOptional) if rotInOptional != None else None,
        c_int(num_segmentsInOptional) if num_segmentsInOptional != None else None,
        c_double(thicknessInOptional) if thicknessInOptional != None else None,
    )
    DrawList_AddEllipse.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_AddEllipseFilled(
    ...
    if not hasattr(DrawList_AddEllipseFilled, "func"):
        ...
        DrawList_AddEllipseFilled.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    DrawList_AddEllipseFilled.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_AddImage(
    ...
    p_max_x,
    p_max_y,
    uv_min_xInOptional=None,
    uv_min_yInOptional=None,
    uv_max_xInOptional=None,
    uv_max_yInOptional=None,
    col_rgbaInOptional=None,
):
    if not hasattr(DrawList_AddImage, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddImage")
        DrawList_AddImage.func = CFUNCTYPE(
            None,
            c_void_p,
            c_void_p,
            c_double,
    ...
    args = (
        ...
        c_double(p_max_x),
        c_double(p_max_y),
        c_double(uv_min_xInOptional) if uv_min_xInOptional != None else None,
        c_double(uv_min_yInOptional) if uv_min_yInOptional != None else None,
        c_double(uv_max_xInOptional) if uv_max_xInOptional != None else None,
        c_double(uv_max_yInOptional) if uv_max_yInOptional != None else None,
        c_int(col_rgbaInOptional) if col_rgbaInOptional != None else None,
    )
    DrawList_AddImage.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_AddImageQuad(
    ...
    p4_x,
    p4_y,
    uv1_xInOptional=None,
    uv1_yInOptional=None,
    uv2_xInOptional=None,
    uv2_yInOptional=None,
    uv3_xInOptional=None,
    uv3_yInOptional=None,
    uv4_xInOptional=None,
    uv4_yInOptional=None,
    col_rgbaInOptional=None,
):
    if not hasattr(DrawList_AddImageQuad, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddImageQuad")
        DrawList_AddImageQuad.func = CFUNCTYPE(
            None,
            c_void_p,
            c_void_p,
            c_double,
    ...
    args = (
        ...
        c_double(p4_x),
        c_double(p4_y),
        c_double(uv1_xInOptional) if uv1_xInOptional != None else None,
        c_double(uv1_yInOptional) if uv1_yInOptional != None else None,
        c_double(uv2_xInOptional) if uv2_xInOptional != None else None,
        c_double(uv2_yInOptional) if uv2_yInOptional != None else None,
        c_double(uv3_xInOptional) if uv3_xInOptional != None else None,
        c_double(uv3_yInOptional) if uv3_yInOptional != None else None,
        c_double(uv4_xInOptional) if uv4_xInOptional != None else None,
        c_double(uv4_yInOptional) if uv4_yInOptional != None else None,
        c_int(col_rgbaInOptional) if col_rgbaInOptional != None else None,
    )
    DrawList_AddImageQuad.func(
        args[0],
        args[1],
        args[2],
        args[3],
        ...
        byref(args[10]) if args[10] != None else None,
        byref(args[11]) if args[11] != None else None,
        byref(args[12]) if args[12] != None else None,
        byref(args[13]) if args[13] != None else None,
        byref(args[14]) if args[14] != None else None,
        byref(args[15]) if args[15] != None else None,
        byref(args[16]) if args[16] != None else None,
        byref(args[17]) if args[17] != None else None,
        byref(args[18]) if args[18] != None else None,
    )


def DrawList_AddImageRounded(
    draw_list,
    image,
    p_min_x,
    p_min_y,
    ...
    if not hasattr(DrawList_AddImageRounded, "func"):
        ...
        DrawList_AddImageRounded.func = CFUNCTYPE(
            None,
            c_void_p,
            c_void_p,
            c_double,
...
def DrawList_AddLine(
    draw_list, p1_x, p1_y, p2_x, p2_y, col_rgba, thicknessInOptional=None
):
    if not hasattr(DrawList_AddLine, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddLine")
        DrawList_AddLine.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double, c_int, c_void_p
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(p1_x),
...
def DrawList_AddNgon(
    ...
    if not hasattr(DrawList_AddNgon, "func"):
        ...
        DrawList_AddNgon.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_int, c_int, c_void_p
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(center_x),
...
def DrawList_AddNgonFilled(
    draw_list, center_x, center_y, radius, col_rgba, num_segments
):
    if not hasattr(DrawList_AddNgonFilled, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddNgonFilled")
        DrawList_AddNgonFilled.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_int, c_int
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(center_x),
...
def DrawList_AddPolyline(draw_list, points, col_rgba, flags, thickness):
    if not hasattr(DrawList_AddPolyline, "func"):
        ...
        DrawList_AddPolyline.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_int, c_int, c_double
        )(proc)
    args = (
        c_void_p(draw_list),
        c_void_p(points),
...
def DrawList_AddQuad(
    ...
    if not hasattr(DrawList_AddQuad, "func"):
        ...
        DrawList_AddQuad.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
...
def DrawList_AddQuadFilled(
    ...
    if not hasattr(DrawList_AddQuadFilled, "func"):
        ...
        DrawList_AddQuadFilled.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
...
def DrawList_AddRect(
    ...
    args = (
        ...
        c_double(p_max_y),
        c_int(col_rgba),
        c_double(roundingInOptional) if roundingInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
        c_double(thicknessInOptional) if thicknessInOptional != None else None,
    )
    DrawList_AddRect.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_AddRectFilled(
    ...
    if not hasattr(DrawList_AddRectFilled, "func"):
        ...
        DrawList_AddRectFilled.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
...
def DrawList_AddRectFilledMultiColor(
    draw_list,
    p_min_x,
    p_min_y,
    p_max_x,
    ...
    if not hasattr(DrawList_AddRectFilledMultiColor, "func"):
        ...
        DrawList_AddRectFilledMultiColor.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    DrawList_AddRectFilledMultiColor.func(
...
def DrawList_AddText(draw_list, x, y, col_rgba, text):
    if not hasattr(DrawList_AddText, "func"):
        ...
        DrawList_AddText.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_int, c_char_p
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(x),
...
def DrawList_AddTextEx(
    ...
    col_rgba,
    text,
    wrap_widthInOptional=None,
    cpu_fine_clip_rect_min_xInOptional=None,
    cpu_fine_clip_rect_min_yInOptional=None,
    cpu_fine_clip_rect_max_xInOptional=None,
    cpu_fine_clip_rect_max_yInOptional=None,
):
    if not hasattr(DrawList_AddTextEx, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddTextEx")
        DrawList_AddTextEx.func = CFUNCTYPE(
            None,
            c_void_p,
            c_void_p,
            c_double,
    ...
    args = (
        ...
        c_int(col_rgba),
        rpr_packsc(text),
        c_double(wrap_widthInOptional) if wrap_widthInOptional != None else None,
        c_double(cpu_fine_clip_rect_min_xInOptional)
        if cpu_fine_clip_rect_min_xInOptional != None
        else None,
        c_double(cpu_fine_clip_rect_min_yInOptional)
        if cpu_fine_clip_rect_min_yInOptional != None
        else None,
        c_double(cpu_fine_clip_rect_max_xInOptional)
        if cpu_fine_clip_rect_max_xInOptional != None
        else None,
        c_double(cpu_fine_clip_rect_max_yInOptional)
        if cpu_fine_clip_rect_max_yInOptional != None
        else None,
    )
    DrawList_AddTextEx.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_AddTriangle(
    draw_list, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, col_rgba, thicknessInOptional=None
):
    if not hasattr(DrawList_AddTriangle, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddTriangle")
        DrawList_AddTriangle.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
...
def DrawList_AddTriangleFilled(draw_list, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, col_rgba):
    if not hasattr(DrawList_AddTriangleFilled, "func"):
        ...
        DrawList_AddTriangleFilled.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    DrawList_AddTriangleFilled.func(
...
def DrawList_PathArcTo(
    draw_list, center_x, center_y, radius, a_min, a_max, num_segmentsInOptional=None
):
    if not hasattr(DrawList_PathArcTo, "func"):
        proc = rpr_getfp("ImGui_DrawList_PathArcTo")
        DrawList_PathArcTo.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(center_x),
...
def DrawList_PathArcToFast(
    draw_list, center_x, center_y, radius, a_min_of_12, a_max_of_12
):
    if not hasattr(DrawList_PathArcToFast, "func"):
        proc = rpr_getfp("ImGui_DrawList_PathArcToFast")
        DrawList_PathArcToFast.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_int, c_int
        )(proc)
    args = (
        c_void_p(draw_list),
...
def DrawList_PathBezierCubicCurveTo(
    draw_list, p2_x, p2_y, p3_x, p3_y, p4_x, p4_y, num_segmentsInOptional=None
):
    if not hasattr(DrawList_PathBezierCubicCurveTo, "func"):
        proc = rpr_getfp("ImGui_DrawList_PathBezierCubicCurveTo")
        DrawList_PathBezierCubicCurveTo.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    DrawList_PathBezierCubicCurveTo.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_PathBezierQuadraticCurveTo(
    draw_list, p2_x, p2_y, p3_x, p3_y, num_segmentsInOptional=None
):
    if not hasattr(DrawList_PathBezierQuadraticCurveTo, "func"):
        proc = rpr_getfp("ImGui_DrawList_PathBezierQuadraticCurveTo")
        DrawList_PathBezierQuadraticCurveTo.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(draw_list),
    ...
    DrawList_PathBezierQuadraticCurveTo.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_PathEllipticalArcTo(
    draw_list,
    center_x,
    center_y,
    radius_x,
    ...
    if not hasattr(DrawList_PathEllipticalArcTo, "func"):
        ...
        DrawList_PathEllipticalArcTo.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    DrawList_PathEllipticalArcTo.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def DrawList_PathRect(
    ...
    if not hasattr(DrawList_PathRect, "func"):
        ...
        DrawList_PathRect.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(draw_list),
        c_double(rect_min_x),
...
def DrawList_PathStroke(
    draw_list, col_rgba, flagsInOptional=None, thicknessInOptional=None
):
    if not hasattr(DrawList_PathStroke, "func"):
        proc = rpr_getfp("ImGui_DrawList_PathStroke")
        DrawList_PathStroke.func = CFUNCTYPE(None, c_void_p, c_int, c_void_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(draw_list),
...
def CreateFont(family_or_file, size, flagsInOptional=None):
    ...
    args = (
        rpr_packsc(family_or_file),
        c_int(size),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = CreateFont.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval
...
def CreateFontFromMem(data, size, flagsInOptional=None):
    if not hasattr(CreateFontFromMem, "func"):
        ...
        CreateFontFromMem.func = CFUNCTYPE(c_void_p, c_char_p, c_int, c_int, c_void_p)(
            proc
        )
    args = (
        rpr_packsc(data),
...
def Function_GetValue_Array(func, name, values):
    if not hasattr(Function_GetValue_Array, "func"):
        ...
        Function_GetValue_Array.func = CFUNCTYPE(None, c_void_p, c_char_p, c_void_p)(
            proc
        )
...
def Function_GetValue_String(func, name):
    if not hasattr(Function_GetValue_String, "func"):
        ...
        Function_GetValue_String.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_char_p, c_int
        )(proc)
...
def Function_SetValue_Array(func, name, values):
    if not hasattr(Function_SetValue_Array, "func"):
        ...
        Function_SetValue_Array.func = CFUNCTYPE(None, c_void_p, c_char_p, c_void_p)(
            proc
        )
    args = (c_void_p(func), rpr_packsc(name), c_void_p(values))
...
def Function_SetValue_String(func, name, value):
    if not hasattr(Function_SetValue_String, "func"):
        ...
        Function_SetValue_String.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_char_p, c_int
        )(proc)
...
def Image(
    ...
    image_size_w,
    image_size_h,
    uv0_xInOptional=None,
    uv0_yInOptional=None,
    uv1_xInOptional=None,
    uv1_yInOptional=None,
    tint_col_rgbaInOptional=None,
    border_col_rgbaInOptional=None,
):
    if not hasattr(Image, "func"):
        proc = rpr_getfp("ImGui_Image")
        Image.func = CFUNCTYPE(
            None,
            c_void_p,
            c_void_p,
            c_double,
    ...
    args = (
        c_void_p(ctx),
        c_void_p(image),
        c_double(image_size_w),
        c_double(image_size_h),
        c_double(uv0_xInOptional) if uv0_xInOptional != None else None,
        c_double(uv0_yInOptional) if uv0_yInOptional != None else None,
        c_double(uv1_xInOptional) if uv1_xInOptional != None else None,
        c_double(uv1_yInOptional) if uv1_yInOptional != None else None,
        c_int(tint_col_rgbaInOptional) if tint_col_rgbaInOptional != None else None,
        c_int(border_col_rgbaInOptional) if border_col_rgbaInOptional != None else None,
    )
    Image.func(
        args[0],
        args[1],
...
def ImageButton(
    ...
    args = (
        ...
        c_double(uv1_xInOptional) if uv1_xInOptional != None else None,
        c_double(uv1_yInOptional) if uv1_yInOptional != None else None,
        c_int(bg_col_rgbaInOptional) if bg_col_rgbaInOptional != None else None,
        c_int(tint_col_rgbaInOptional) if tint_col_rgbaInOptional != None else None,
    )
    rval = ImageButton.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def BeginDisabled(ctx, disabledInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_bool(disabledInOptional) if disabledInOptional != None else None,
    )
...
def SetKeyboardFocusHere(ctx, offsetInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_int(offsetInOptional) if offsetInOptional != None else None,
    )
...
def HoveredFlags_AllowWhenBlockedByActiveItem():
    ...
    if not hasattr(HoveredFlags_AllowWhenBlockedByActiveItem, "cache"):
        HoveredFlags_AllowWhenBlockedByActiveItem.cache = (
            HoveredFlags_AllowWhenBlockedByActiveItem.func()
        )
...
def HoveredFlags_AllowWhenBlockedByPopup():
    ...
    if not hasattr(HoveredFlags_AllowWhenBlockedByPopup, "cache"):
        HoveredFlags_AllowWhenBlockedByPopup.cache = (
            HoveredFlags_AllowWhenBlockedByPopup.func()
        )
...
def HoveredFlags_AllowWhenOverlappedByItem():
    ...
    if not hasattr(HoveredFlags_AllowWhenOverlappedByItem, "cache"):
        HoveredFlags_AllowWhenOverlappedByItem.cache = (
            HoveredFlags_AllowWhenOverlappedByItem.func()
        )
...
def HoveredFlags_AllowWhenOverlappedByWindow():
    ...
    if not hasattr(HoveredFlags_AllowWhenOverlappedByWindow, "cache"):
        HoveredFlags_AllowWhenOverlappedByWindow.cache = (
            HoveredFlags_AllowWhenOverlappedByWindow.func()
        )
...
def IsItemClicked(ctx, mouse_buttonInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_int(mouse_buttonInOptional) if mouse_buttonInOptional != None else None,
    )
...
def GetKeyPressedAmount(ctx, key, repeat_delay, rate):
    if not hasattr(GetKeyPressedAmount, "func"):
        ...
        GetKeyPressedAmount.func = CFUNCTYPE(
            c_int, c_void_p, c_int, c_double, c_double
        )(proc)
...
def IsKeyPressed(ctx, key, repeatInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_int(key),
        c_bool(repeatInOptional) if repeatInOptional != None else None,
    )
    rval = IsKeyPressed.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval
...
def GetMouseClickedPos(ctx, button):
    if not hasattr(GetMouseClickedPos, "func"):
        ...
        GetMouseClickedPos.func = CFUNCTYPE(None, c_void_p, c_int, c_void_p, c_void_p)(
            proc
        )
...
def GetMouseDragDelta(ctx, buttonInOptional=None, lock_thresholdInOptional=None):
    if not hasattr(GetMouseDragDelta, "func"):
        ...
        GetMouseDragDelta.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        c_double(0),
        c_double(0),
        c_int(buttonInOptional) if buttonInOptional != None else None,
        c_double(lock_thresholdInOptional)
        if lock_thresholdInOptional != None
        else None,
    )
    GetMouseDragDelta.func(
        args[0],
        byref(args[1]),
        byref(args[2]),
        byref(args[3]) if args[3] != None else None,
...
def GetMousePosOnOpeningCurrentPopup(ctx):
    if not hasattr(GetMousePosOnOpeningCurrentPopup, "func"):
        ...
        GetMousePosOnOpeningCurrentPopup.func = CFUNCTYPE(
...
def IsMouseHoveringRect(ctx, r_min_x, r_min_y, r_max_x, r_max_y, clipInOptional=None):
    if not hasattr(IsMouseHoveringRect, "func"):
        ...
        IsMouseHoveringRect.func = CFUNCTYPE(
            c_bool, c_void_p, c_double, c_double, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        c_double(r_min_x),
        ...
        c_double(r_max_x),
        c_double(r_max_y),
        c_bool(clipInOptional) if clipInOptional != None else None,
    )
    rval = IsMouseHoveringRect.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def IsMousePosValid(ctx, mouse_pos_xInOptional=None, mouse_pos_yInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_double(mouse_pos_xInOptional) if mouse_pos_xInOptional != None else None,
        c_double(mouse_pos_yInOptional) if mouse_pos_yInOptional != None else None,
    )
    rval = IsMousePosValid.func(
        args[0],
        byref(args[1]) if args[1] != None else None,
        byref(args[2]) if args[2] != None else None,
    )
    return rval
...
def Indent(ctx, indent_wInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_double(indent_wInOptional) if indent_wInOptional != None else None,
    )
...
def SameLine(ctx, offset_from_start_xInOptional=None, spacingInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_double(offset_from_start_xInOptional)
        if offset_from_start_xInOptional != None
        else None,
        c_double(spacingInOptional) if spacingInOptional != None else None,
    )
    SameLine.func(
        args[0],
        byref(args[1]) if args[1] != None else None,
...
def IsRectVisibleEx(ctx, rect_min_x, rect_min_y, rect_max_x, rect_max_y):
    if not hasattr(IsRectVisibleEx, "func"):
        ...
        IsRectVisibleEx.func = CFUNCTYPE(
            c_bool, c_void_p, c_double, c_double, c_double, c_double
        )(proc)
    args = (
        c_void_p(ctx),
        c_double(rect_min_x),
...
def PushClipRect(
    ...
    if not hasattr(PushClipRect, "func"):
        ...
        PushClipRect.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double, c_bool
        )(proc)
    args = (
        c_void_p(ctx),
        c_double(clip_rect_min_x),
        ...
        c_double(clip_rect_max_x),
        c_double(clip_rect_max_y),
        c_bool(intersect_with_current_clip_rect),
    )
...
def ListClipper_Begin(clipper, items_count, items_heightInOptional=None):
    ...
    args = (
        c_void_p(clipper),
        c_int(items_count),
        c_double(items_heightInOptional) if items_heightInOptional != None else None,
    )
    ListClipper_Begin.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
...
def ListClipper_GetDisplayRange(clipper):
    if not hasattr(ListClipper_GetDisplayRange, "func"):
        ...
        ListClipper_GetDisplayRange.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_void_p
        )(proc)
...
def ListClipper_IncludeItemsByIndex(clipper, item_begin, item_end):
    if not hasattr(ListClipper_IncludeItemsByIndex, "func"):
        ...
        ListClipper_IncludeItemsByIndex.func = CFUNCTYPE(None, c_void_p, c_int, c_int)(
            proc
        )
...
def BeginMenu(ctx, label, enabledInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_bool(enabledInOptional) if enabledInOptional != None else None,
    )
...
def MenuItem(
    ctx,
    label,
    shortcutInOptional=None,
    p_selectedInOutOptional=None,
    enabledInOptional=None,
):
    if not hasattr(MenuItem, "func"):
        proc = rpr_getfp("ImGui_MenuItem")
        MenuItem.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        rpr_packsc(shortcutInOptional) if shortcutInOptional != None else None,
        c_bool(p_selectedInOutOptional) if p_selectedInOutOptional != None else None,
        c_bool(enabledInOptional) if enabledInOptional != None else None,
    )
    rval = MenuItem.func(
...
def PlotHistogram(
    ...
    label,
    values,
    values_offsetInOptional=None,
    overlay_textInOptional=None,
    scale_minInOptional=None,
    scale_maxInOptional=None,
    graph_size_wInOptional=None,
    graph_size_hInOptional=None,
):
    if not hasattr(PlotHistogram, "func"):
        proc = rpr_getfp("ImGui_PlotHistogram")
        PlotHistogram.func = CFUNCTYPE(
            None,
            c_void_p,
            c_char_p,
            c_void_p,
    ...
    args = (
        ...
        rpr_packsc(label),
        c_void_p(values),
        c_int(values_offsetInOptional) if values_offsetInOptional != None else None,
        rpr_packsc(overlay_textInOptional) if overlay_textInOptional != None else None,
        c_double(scale_minInOptional) if scale_minInOptional != None else None,
        c_double(scale_maxInOptional) if scale_maxInOptional != None else None,
        c_double(graph_size_wInOptional) if graph_size_wInOptional != None else None,
        c_double(graph_size_hInOptional) if graph_size_hInOptional != None else None,
    )
    PlotHistogram.func(
        args[0],
        args[1],
...
def BeginPopupModal(ctx, name, p_openInOutOptional=None, flagsInOptional=None):
    if not hasattr(BeginPopupModal, "func"):
        ...
        BeginPopupModal.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(name),
        c_bool(p_openInOutOptional) if p_openInOutOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = BeginPopupModal.func(
        args[0],
        args[1],
        byref(args[2]) if args[2] != None else None,
        byref(args[3]) if args[3] != None else None,
...
def OpenPopup(ctx, str_id, popup_flagsInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        rpr_packsc(str_id),
        c_int(popup_flagsInOptional) if popup_flagsInOptional != None else None,
    )
...
def OpenPopupOnItemClick(ctx, str_idInOptional=None, popup_flagsInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        rpr_packsc(str_idInOptional) if str_idInOptional != None else None,
        c_int(popup_flagsInOptional) if popup_flagsInOptional != None else None,
    )
    OpenPopupOnItemClick.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
...
def PopupFlags_NoOpenOverExistingPopup():
    ...
    if not hasattr(PopupFlags_NoOpenOverExistingPopup, "cache"):
        PopupFlags_NoOpenOverExistingPopup.cache = (
            PopupFlags_NoOpenOverExistingPopup.func()
        )
...
def BeginPopupContextItem(ctx, str_idInOptional=None, popup_flagsInOptional=None):
    if not hasattr(BeginPopupContextItem, "func"):
        ...
        BeginPopupContextItem.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
    ...
    rval = BeginPopupContextItem.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval
...
def BeginPopupContextWindow(ctx, str_idInOptional=None, popup_flagsInOptional=None):
    if not hasattr(BeginPopupContextWindow, "func"):
        ...
        BeginPopupContextWindow.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
    ...
    rval = BeginPopupContextWindow.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval
...
def GetColor(ctx, idx, alpha_mulInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_int(idx),
        c_double(alpha_mulInOptional) if alpha_mulInOptional != None else None,
    )
...
def PushStyleVar(ctx, var_idx, val1, val2InOptional=None):
    ...
    args = (
        ...
        c_int(var_idx),
        c_double(val1),
        c_double(val2InOptional) if val2InOptional != None else None,
    )
    PushStyleVar.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )
...
def StyleVar_TableAngledHeadersTextAlign():
    ...
    if not hasattr(StyleVar_TableAngledHeadersTextAlign, "cache"):
        StyleVar_TableAngledHeadersTextAlign.cache = (
            StyleVar_TableAngledHeadersTextAlign.func()
        )
...
def TabBarFlags_FittingPolicyResizeDown():
    ...
    if not hasattr(TabBarFlags_FittingPolicyResizeDown, "cache"):
        TabBarFlags_FittingPolicyResizeDown.cache = (
            TabBarFlags_FittingPolicyResizeDown.func()
        )
...
def TabBarFlags_NoCloseWithMiddleMouseButton():
    ...
    if not hasattr(TabBarFlags_NoCloseWithMiddleMouseButton, "cache"):
        TabBarFlags_NoCloseWithMiddleMouseButton.cache = (
            TabBarFlags_NoCloseWithMiddleMouseButton.func()
        )
...
def TabBarFlags_NoTabListScrollingButtons():
    ...
    if not hasattr(TabBarFlags_NoTabListScrollingButtons, "cache"):
        TabBarFlags_NoTabListScrollingButtons.cache = (
            TabBarFlags_NoTabListScrollingButtons.func()
        )
...
def BeginTabItem(ctx, label, p_openInOutOptional=None, flagsInOptional=None):
    if not hasattr(BeginTabItem, "func"):
        ...
        BeginTabItem.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
...
def TabItemFlags_NoCloseWithMiddleMouseButton():
    ...
    if not hasattr(TabItemFlags_NoCloseWithMiddleMouseButton, "cache"):
        TabItemFlags_NoCloseWithMiddleMouseButton.cache = (
            TabItemFlags_NoCloseWithMiddleMouseButton.func()
        )
...
def BeginTable(
    ...
    columns,
    flagsInOptional=None,
    outer_size_wInOptional=None,
    outer_size_hInOptional=None,
    inner_widthInOptional=None,
):
    if not hasattr(BeginTable, "func"):
        proc = rpr_getfp("ImGui_BeginTable")
        BeginTable.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_int, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(str_id),
        c_int(columns),
        c_int(flagsInOptional) if flagsInOptional != None else None,
        c_double(outer_size_wInOptional) if outer_size_wInOptional != None else None,
        c_double(outer_size_hInOptional) if outer_size_hInOptional != None else None,
        c_double(inner_widthInOptional) if inner_widthInOptional != None else None,
    )
    rval = BeginTable.func(
        args[0],
        args[1],
        args[2],
        byref(args[3]) if args[3] != None else None,
...
def TableNextRow(ctx, row_flagsInOptional=None, min_row_heightInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_int(row_flagsInOptional) if row_flagsInOptional != None else None,
        c_double(min_row_heightInOptional)
        if min_row_heightInOptional != None
        else None,
    )
    TableNextRow.func(
        args[0],
...
def TableSetBgColor(ctx, target, color_rgba, column_nInOptional=None):
    ...
    args = (
        ...
        c_int(target),
        c_int(color_rgba),
        c_int(column_nInOptional) if column_nInOptional != None else None,
    )
    TableSetBgColor.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )
...
def TableSetupColumn(
    ctx,
    label,
    flagsInOptional=None,
    init_width_or_weightInOptional=None,
    user_idInOptional=None,
):
    if not hasattr(TableSetupColumn, "func"):
        proc = rpr_getfp("ImGui_TableSetupColumn")
        TableSetupColumn.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_int(flagsInOptional) if flagsInOptional != None else None,
        c_double(init_width_or_weightInOptional)
        if init_width_or_weightInOptional != None
        else None,
        c_int(user_idInOptional) if user_idInOptional != None else None,
    )
    TableSetupColumn.func(
        args[0],
        args[1],
        byref(args[2]) if args[2] != None else None,
        byref(args[3]) if args[3] != None else None,
...
def TableColumnFlags_NoSortDescending():
    ...
    if not hasattr(TableColumnFlags_NoSortDescending, "cache"):
        TableColumnFlags_NoSortDescending.cache = (
            TableColumnFlags_NoSortDescending.func()
        )
...
def TableColumnFlags_PreferSortAscending():
    ...
    if not hasattr(TableColumnFlags_PreferSortAscending, "cache"):
        TableColumnFlags_PreferSortAscending.cache = (
            TableColumnFlags_PreferSortAscending.func()
        )
...
def TableColumnFlags_PreferSortDescending():
    ...
    if not hasattr(TableColumnFlags_PreferSortDescending, "cache"):
        TableColumnFlags_PreferSortDescending.cache = (
            TableColumnFlags_PreferSortDescending.func()
        )
...
def TableGetColumnSortSpecs(ctx, id):
    if not hasattr(TableGetColumnSortSpecs, "func"):
        ...
        TableGetColumnSortSpecs.func = CFUNCTYPE(
            c_bool, c_void_p, c_int, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (c_void_p(ctx), c_int(id), c_int(0), c_int(0), c_int(0))
    rval = TableGetColumnSortSpecs.func(
        args[0], args[1], byref(args[2]), byref(args[3]), byref(args[4])
    )
    return rval, int(args[2].value), int(args[3].value), int(args[4].value)
...
def TableFlags_HighlightHoveredColumn():
    ...
    if not hasattr(TableFlags_HighlightHoveredColumn, "cache"):
        TableFlags_HighlightHoveredColumn.cache = (
            TableFlags_HighlightHoveredColumn.func()
        )
...
def CalcTextSize(
    ctx, text, hide_text_after_double_hashInOptional=None, wrap_widthInOptional=None
):
    if not hasattr(CalcTextSize, "func"):
        proc = rpr_getfp("ImGui_CalcTextSize")
        CalcTextSize.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(text),
        c_double(0),
        c_double(0),
        c_bool(hide_text_after_double_hashInOptional)
        if hide_text_after_double_hashInOptional != None
        else None,
        c_double(wrap_widthInOptional) if wrap_widthInOptional != None else None,
    )
    CalcTextSize.func(
...
def PushTextWrapPos(ctx, wrap_local_pos_xInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_double(wrap_local_pos_xInOptional)
        if wrap_local_pos_xInOptional != None
        else None,
    )
...
def InputDouble(
    ...
    args = (
        ...
        rpr_packsc(label),
        c_double(vInOut),
        c_double(stepInOptional) if stepInOptional != None else None,
        c_double(step_fastInOptional) if step_fastInOptional != None else None,
        rpr_packsc(formatInOptional) if formatInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = InputDouble.func(
        args[0],
        args[1],
        byref(args[2]),
        byref(args[3]) if args[3] != None else None,
...
def InputDouble2(
    ctx, label, v1InOut, v2InOut, formatInOptional=None, flagsInOptional=None
):
    if not hasattr(InputDouble2, "func"):
        proc = rpr_getfp("ImGui_InputDouble2")
        InputDouble2.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
...
def InputDouble3(
    ctx, label, v1InOut, v2InOut, v3InOut, formatInOptional=None, flagsInOptional=None
):
    if not hasattr(InputDouble3, "func"):
        proc = rpr_getfp("ImGui_InputDouble3")
        InputDouble3.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
...
def InputInt(
    ...
    args = (
        ...
        rpr_packsc(label),
        c_int(vInOut),
        c_int(stepInOptional) if stepInOptional != None else None,
        c_int(step_fastInOptional) if step_fastInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = InputInt.func(
        args[0],
...
def InputInt4(ctx, label, v1InOut, v2InOut, v3InOut, v4InOut, flagsInOptional=None):
    if not hasattr(InputInt4, "func"):
        ...
        InputInt4.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
...
def InputText(
    ctx, label, bufInOutNeedBig, flagsInOptional=None, callbackInOptional=None
):
    if not hasattr(InputText, "func"):
        proc = rpr_getfp("ImGui_InputText")
        InputText.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_int, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        rpr_packs(bufInOutNeedBig),
        c_int(4096),
        c_int(flagsInOptional) if flagsInOptional != None else None,
        c_void_p(callbackInOptional) if callbackInOptional != None else None,
    )
    rval = InputText.func(
        args[0],
        args[1],
...
def InputTextWithHint(
    ctx, label, hint, bufInOutNeedBig, flagsInOptional=None, callbackInOptional=None
):
    if not hasattr(InputTextWithHint, "func"):
        proc = rpr_getfp("ImGui_InputTextWithHint")
        InputTextWithHint.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_char_p, c_int, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
...
def InputTextFlags_CallbackCharFilter():
    ...
    if not hasattr(InputTextFlags_CallbackCharFilter, "cache"):
        InputTextFlags_CallbackCharFilter.cache = (
            InputTextFlags_CallbackCharFilter.func()
        )
...
def InputTextFlags_CallbackCompletion():
    ...
    if not hasattr(InputTextFlags_CallbackCompletion, "cache"):
        InputTextFlags_CallbackCompletion.cache = (
            InputTextFlags_CallbackCompletion.func()
        )
...
def InputTextFlags_CtrlEnterForNewLine():
    ...
    if not hasattr(InputTextFlags_CtrlEnterForNewLine, "cache"):
        InputTextFlags_CtrlEnterForNewLine.cache = (
            InputTextFlags_CtrlEnterForNewLine.func()
        )
...
def InputTextFlags_DisplayEmptyRefVal():
    ...
    if not hasattr(InputTextFlags_DisplayEmptyRefVal, "cache"):
        InputTextFlags_DisplayEmptyRefVal.cache = (
            InputTextFlags_DisplayEmptyRefVal.func()
        )
...
def InputTextFlags_NoHorizontalScroll():
    ...
    if not hasattr(InputTextFlags_NoHorizontalScroll, "cache"):
        InputTextFlags_NoHorizontalScroll.cache = (
            InputTextFlags_NoHorizontalScroll.func()
        )
...
def CreateTextFilter(default_filterInOptional=None):
    ...
    args = (
        rpr_packsc(default_filterInOptional)
        if default_filterInOptional != None
        else None,
    )
...
def TextFilter_Draw(filter, ctx, labelInOptional=None, widthInOptional=None):
    if not hasattr(TextFilter_Draw, "func"):
        ...
        TextFilter_Draw.func = CFUNCTYPE(
            c_bool, c_void_p, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        c_void_p(filter),
        c_void_p(ctx),
        rpr_packsc(labelInOptional) if labelInOptional != None else None,
        c_double(widthInOptional) if widthInOptional != None else None,
    )
    rval = TextFilter_Draw.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )
    return rval
...
def CollapsingHeader(ctx, label, p_visibleInOutOptional=None, flagsInOptional=None):
    if not hasattr(CollapsingHeader, "func"):
        ...
        CollapsingHeader.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(label),
        c_bool(p_visibleInOutOptional) if p_visibleInOutOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = CollapsingHeader.func(
        args[0],
        args[1],
        byref(args[2]) if args[2] != None else None,
        byref(args[3]) if args[3] != None else None,
...
def TreeNodeEx(ctx, str_id, label, flagsInOptional=None):
    if not hasattr(TreeNodeEx, "func"):
        ...
        TreeNodeEx.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_char_p, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
...
def GetVersion():
    if not hasattr(GetVersion, "func"):
        ...
        GetVersion.func = CFUNCTYPE(None, c_char_p, c_int, c_void_p, c_char_p, c_int)(
            proc
        )
...
def PointConvertNative(ctx, xInOut, yInOut, to_nativeInOptional=None):
    if not hasattr(PointConvertNative, "func"):
        ...
        PointConvertNative.func = CFUNCTYPE(
    ...
    args = (
        ...
        c_double(xInOut),
        c_double(yInOut),
        c_bool(to_nativeInOptional) if to_nativeInOptional != None else None,
    )
    PointConvertNative.func(
        args[0],
        byref(args[1]),
        byref(args[2]),
        byref(args[3]) if args[3] != None else None,
...
def ProgressBar(
    ctx,
    fraction,
    size_arg_wInOptional=None,
    size_arg_hInOptional=None,
    overlayInOptional=None,
):
    if not hasattr(ProgressBar, "func"):
        proc = rpr_getfp("ImGui_ProgressBar")
        ProgressBar.func = CFUNCTYPE(
            None, c_void_p, c_double, c_void_p, c_void_p, c_char_p
        )(proc)
    args = (
        c_void_p(ctx),
        c_double(fraction),
        c_double(size_arg_wInOptional) if size_arg_wInOptional != None else None,
        c_double(size_arg_hInOptional) if size_arg_hInOptional != None else None,
        rpr_packsc(overlayInOptional) if overlayInOptional != None else None,
    )
    ProgressBar.func(
        args[0],
        args[1],
...
def ColorConvertDouble4ToU32(r, g, b, a):
    if not hasattr(ColorConvertDouble4ToU32, "func"):
        ...
        ColorConvertDouble4ToU32.func = CFUNCTYPE(
            c_int, c_double, c_double, c_double, c_double
        )(proc)
...
def ColorConvertHSVtoRGB(h, s, v):
    if not hasattr(ColorConvertHSVtoRGB, "func"):
        ...
        ColorConvertHSVtoRGB.func = CFUNCTYPE(
            None, c_double, c_double, c_double, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_double(h),
        c_double(s),
    ...
    ColorConvertHSVtoRGB.func(
        args[0], args[1], args[2], byref(args[3]), byref(args[4]), byref(args[5])
    )
...
def ColorConvertRGBtoHSV(r, g, b):
    if not hasattr(ColorConvertRGBtoHSV, "func"):
        ...
        ColorConvertRGBtoHSV.func = CFUNCTYPE(
            None, c_double, c_double, c_double, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_double(r),
...
def ColorConvertU32ToDouble4(rgba):
    if not hasattr(ColorConvertU32ToDouble4, "func"):
        ...
        ColorConvertU32ToDouble4.func = CFUNCTYPE(
            None, c_int, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (c_int(rgba), c_double(0), c_double(0), c_double(0), c_double(0))
    ColorConvertU32ToDouble4.func(
        args[0], byref(args[1]), byref(args[2]), byref(args[3]), byref(args[4])
    )
    return (
        float(args[1].value),
        float(args[2].value),
...
def LogToClipboard(ctx, auto_open_depthInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_int(auto_open_depthInOptional) if auto_open_depthInOptional != None else None,
    )
...
def LogToFile(ctx, auto_open_depthInOptional=None, filenameInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_int(auto_open_depthInOptional) if auto_open_depthInOptional != None else None,
        rpr_packsc(filenameInOptional) if filenameInOptional != None else None,
    )
...
def Viewport_GetWorkCenter(viewport):
    if not hasattr(Viewport_GetWorkCenter, "func"):
        ...
        Viewport_GetWorkCenter.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (c_void_p(viewport), c_double(0), c_double(0))
...
def BeginChild(
    ...
    size_wInOptional=None,
    size_hInOptional=None,
    child_flagsInOptional=None,
    window_flagsInOptional=None,
):
    if not hasattr(BeginChild, "func"):
        proc = rpr_getfp("ImGui_BeginChild")
        BeginChild.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        ...
        c_double(size_wInOptional) if size_wInOptional != None else None,
        c_double(size_hInOptional) if size_hInOptional != None else None,
        c_int(child_flagsInOptional) if child_flagsInOptional != None else None,
        c_int(window_flagsInOptional) if window_flagsInOptional != None else None,
    )
    rval = BeginChild.func(
        args[0],
        args[1],
        byref(args[2]) if args[2] != None else None,
        byref(args[3]) if args[3] != None else None,
...
def ChildFlags_AlwaysUseWindowPadding():
    ...
    if not hasattr(ChildFlags_AlwaysUseWindowPadding, "cache"):
        ChildFlags_AlwaysUseWindowPadding.cache = (
            ChildFlags_AlwaysUseWindowPadding.func()
        )
...
def GetWindowContentRegionMax(ctx):
    if not hasattr(GetWindowContentRegionMax, "func"):
        ...
        GetWindowContentRegionMax.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (c_void_p(ctx), c_double(0), c_double(0))
...
def GetWindowContentRegionMin(ctx):
    if not hasattr(GetWindowContentRegionMin, "func"):
        ...
        GetWindowContentRegionMin.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (c_void_p(ctx), c_double(0), c_double(0))
...
def WindowFlags_AlwaysHorizontalScrollbar():
    ...
    if not hasattr(WindowFlags_AlwaysHorizontalScrollbar, "cache"):
        WindowFlags_AlwaysHorizontalScrollbar.cache = (
            WindowFlags_AlwaysHorizontalScrollbar.func()
        )
...
def WindowFlags_AlwaysVerticalScrollbar():
    ...
    if not hasattr(WindowFlags_AlwaysVerticalScrollbar, "cache"):
        WindowFlags_AlwaysVerticalScrollbar.cache = (
            WindowFlags_AlwaysVerticalScrollbar.func()
        )
...
def SetNextWindowContentSize(ctx, size_w, size_h):
    if not hasattr(SetNextWindowContentSize, "func"):
        ...
        SetNextWindowContentSize.func = CFUNCTYPE(None, c_void_p, c_double, c_double)(
            proc
        )
    args = (c_void_p(ctx), c_double(size_w), c_double(size_h))
...
def SetNextWindowPos(
    ...
    pos_y,
    condInOptional=None,
    pivot_xInOptional=None,
    pivot_yInOptional=None,
):
    if not hasattr(SetNextWindowPos, "func"):
        proc = rpr_getfp("ImGui_SetNextWindowPos")
        SetNextWindowPos.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        c_double(pos_x),
        c_double(pos_y),
        c_int(condInOptional) if condInOptional != None else None,
        c_double(pivot_xInOptional) if pivot_xInOptional != None else None,
        c_double(pivot_yInOptional) if pivot_yInOptional != None else None,
    )
    SetNextWindowPos.func(
        args[0],
        args[1],
        args[2],
        byref(args[3]) if args[3] != None else None,
...
def SetNextWindowSize(ctx, size_w, size_h, condInOptional=None):
    if not hasattr(SetNextWindowSize, "func"):
        ...
        SetNextWindowSize.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        c_double(size_w),
    ...
    SetNextWindowSize.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )


def SetNextWindowSizeConstraints(
    ctx, size_min_w, size_min_h, size_max_w, size_max_h, custom_callbackInOptional=None
):
    if not hasattr(SetNextWindowSizeConstraints, "func"):
        proc = rpr_getfp("ImGui_SetNextWindowSizeConstraints")
        SetNextWindowSizeConstraints.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        ...
        c_double(size_max_w),
        c_double(size_max_h),
        c_void_p(custom_callbackInOptional)
        if custom_callbackInOptional != None
        else None,
    )
    SetNextWindowSizeConstraints.func(
...
def SetWindowCollapsedEx(ctx, name, collapsed, condInOptional=None):
    if not hasattr(SetWindowCollapsedEx, "func"):
        ...
        SetWindowCollapsedEx.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_bool, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(name),
...
def SetWindowPos(ctx, pos_x, pos_y, condInOptional=None):
    if not hasattr(SetWindowPos, "func"):
        ...
        SetWindowPos.func = CFUNCTYPE(None, c_void_p, c_double, c_double, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
...
def SetWindowPosEx(ctx, name, pos_x, pos_y, condInOptional=None):
    if not hasattr(SetWindowPosEx, "func"):
        ...
        SetWindowPosEx.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
        rpr_packsc(name),
...
def SetWindowSize(ctx, size_w, size_h, condInOptional=None):
    if not hasattr(SetWindowSize, "func"):
        ...
        SetWindowSize.func = CFUNCTYPE(None, c_void_p, c_double, c_double, c_void_p)(
            proc
        )
    args = (
        c_void_p(ctx),
...
def SetWindowSizeEx(ctx, name, size_w, size_h, condInOptional=None):
    if not hasattr(SetWindowSizeEx, "func"):
        ...
        SetWindowSizeEx.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_double, c_double, c_void_p
        )(proc)
    args = (
        c_void_p(ctx),
...
def SetScrollFromPosX(ctx, local_x, center_x_ratioInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_double(local_x),
        c_double(center_x_ratioInOptional)
        if center_x_ratioInOptional != None
        else None,
    )
    SetScrollFromPosX.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
...
def SetScrollFromPosY(ctx, local_y, center_y_ratioInOptional=None):
    ...
    args = (
        c_void_p(ctx),
        c_double(local_y),
        c_double(center_y_ratioInOptional)
        if center_y_ratioInOptional != None
        else None,
    )
    SetScrollFromPosY.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
